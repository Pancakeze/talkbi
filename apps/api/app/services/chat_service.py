...
def _validated_staging_tables(ds: DataSource) -> list[dict]:
    """
    Client-created data sources can contain arbitrary connection_info JSON.
    Only trust staging metadata that matches server-created Excel tables for
    this exact data source before building executable SQL from it.
    """
