...
def validate_runtime_settings() -> None:
    ...
    if env in PRODUCTION_ENVIRONMENTS and settings.secret_key == DEFAULT_SECRET_KEY:
        raise RuntimeError("SECRET_KEY must be set to a non-default value in staging/production.")
